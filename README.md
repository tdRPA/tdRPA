...
<span style="color:red;font-size:18px">Support Python 3.7+ Windows x64([Except for 3.7.6 3.8.1](https://github.com/yinkaisheng/Python-UIAutomation-for-Windows))</span>
